...
G53 G0 X371.7 Y295 F12000    ; Rapid to the back of the post. Stay away from the tool rack so we don't collide with tools.
...
G53 G1 Y341 F6000            ; Controlled move to the park position with tool 3. (park_x, park_y)
